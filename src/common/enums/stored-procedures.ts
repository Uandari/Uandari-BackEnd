...
export enum TECHNICIAN_PROCEDURES {
 GET_ALL_TECHNICIANS = 'SELECT * FROM COMPLETETECHNICIANS ',
}
export enum OBJECTIVESINDICATORS_PROCEDURES {
  GET_OBJECTIVESINDICATORS = 'SELECT * FROM OBJECTIVESINDICATORS WHERE isDelete = 0',
  //1: idUser, 2: security_MUST, 3: productionVolume_MUST, 4: issuesB_MUST, 5: issuesC1_MUST, 6: damagedMaterial_MUST
  INSERT_OBJECTIVESINDICATORS = 'BEGIN ADDOBJECTIVESINDICATORS(:1,:2,:3,:4,:5,:6); END;',
  //1: idObjectivesIndicators, 2: idUser, 3: security_MUST, 4: productionVolume_MUST, 5: issuesB_MUST, 6: issuesC1_MUST, 7: damagedMaterial_MUST
  UPDATE_OBJECTIVESINDICATORS = 'BEGIN UPDATEOBJECTIVESINDICATORS(:1,:2,:3,:4,:5,:6,:7); END;',
  //1: idObjectivesIndicators
  DELETE_OBJECTIVESINDICATORS = 'BEGIN DELETEOBJECTIVESINDICATORS(:1); END;',
  //idObjectivesIndicators
  GETBYID = 'SELECT * FROM OBJECTIVESINDICATORS WHERE idObjectivesIndicators = :1 ',
}