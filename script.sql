 ...
 */
CREATE TABLE OBJECTIVESINDICATORS (
    idObjectivesIndicators NUMBER GENERATED ALWAYS AS IDENTITY,
    idUser NUMBER,
 ...
 */
CREATE
OR REPLACE PROCEDURE ADDOBJECTIVESINDICATOR (
    p_idUser IN NUMBER,
...
END ADDOBJECTIVESINDICATOR;

/*
 SP UPDATE OBJECTIVES INDICATORS
 */
CREATE
OR REPLACE PROCEDURE UPDATEOBJECTIVESINDICATOR (
...
CREATE
OR REPLACE PROCEDURE DELETEOBJECTIVESINDICATORS(p_idObjectivesIndicators IN NUMBER) AS BEGIN
UPDATE
    OBJECTIVESINDICATORS
SET
    isDelete = 1
...
WHEN OTHERS THEN ROLLBACK;
RAISE;
END DELETEOBJECTIVESINDICATORS;
