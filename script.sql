...
CREATE TABLE OBJECTIVES_INDICATORS (
    ...
    CONSTRAINT pk_idObjectivesIndicators PRIMARY KEY (idObjectivesIndicators)
);

/*
	SP INSERT OBJECTIVES INDICATORS
*/
CREATE OR REPLACE PROCEDURE INSERT_OBJECTIVES_INDICATOR (
    p_idUser IN NUMBER,
...
AS
BEGIN
    INSERT INTO OBJECTIVES_INDICATORS (
        idUser,
        security_MUST,
...
*/
CREATE OR REPLACE PROCEDURE UPDATE_OBJECTIVES_INDICATOR (
...
BEGIN
    ...
    WHERE idObjectivesIndicators = p_idObjectivesIndicators;
...
CREATE TABLE LINE (
    ...
    CONSTRAINT pk_idLine PRIMARY KEY (idLine)
);

/*
	SP INSERT LINE
*/
CREATE OR REPLACE PROCEDURE INSERT_LINE (
    lineName IN VARCHAR2,
)
AS
BEGIN
...
/*
    SP DELETE LINE
*/
CREATE OR REPLACE PROCEDURE DELETE_LINE (
    p_idLine IN NUMBER
)
AS
BEGIN
...
*/
CREATE
OR REPLACE PROCEDURE DELETE_LINE(p_idLine IN NUMBER) AS BEGIN
UPDATE
    LINE
SET
    isDelete = 1
